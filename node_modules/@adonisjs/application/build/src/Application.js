...
class Application {
    constructor(appRoot, environment, rcContents) {
        ...
        this.rcFile = rcParser_1.parse(rcContents || this.loadRcFile());
    ...
    registerAliases() {
        this.aliasesMap.forEach((toPath, alias) => {
            this.container.alias(path_1.join(this.appRoot, toPath), alias);
        });
    }
    /**
    ...
    loadEnvironmentVariables() {
         ...
         */
        const { envContents, testEnvContent } = env_1.envLoader(this.appRoot);
        /**
    ...
    async registerProviders() {
        ...
        await this.profiler.profile('providers:register', {}, async () => {
            const providers = this.environment !== 'web'
