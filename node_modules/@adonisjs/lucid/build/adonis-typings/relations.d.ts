declare module '@ioc:Adonis/Lucid/Relations' {
    ...
    interface HasManyClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel> extends HasOneClientContract<Relation, RelatedModel> {
         ...
         */
        fetchOrCreateMany(payload: Partial<ModelAttributes<InstanceType<RelatedModel>>>[], predicate?: keyof ModelAttributes<InstanceType<RelatedModel>> | (keyof ModelAttributes<InstanceType<RelatedModel>>)[]): Promise<InstanceType<RelatedModel>[]>;
        /**
         * Update or create rows. Providers a great API to sync rows
         */
        updateOrCreateMany(payload: Partial<ModelAttributes<InstanceType<RelatedModel>>>[], predicate?: keyof ModelAttributes<InstanceType<RelatedModel>> | (keyof ModelAttributes<InstanceType<RelatedModel>>)[]): Promise<InstanceType<RelatedModel>[]>;
        /**
         * Return a query builder instance of the relationship
         */
     ...
     */
    interface WithAggregate<Model extends LucidRow, Builder extends any> {
        <Name extends ExtractModelRelations<Model>, RelatedBuilder = Model[Name] extends ModelRelations ? Model[Name]['subQuery'] : never>(relation: Name, callback: (builder: RelatedBuilder) => void): Builder;
    }
    /**
     * The has function
