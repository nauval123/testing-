...
class Props {
     ...
     */
    has(key) {
        const value = utils_1.lodash.get(this[Symbol.for('options')].props, key);
     ...
     */
    only(keys) {
        return utils_1.lodash.pick(this[Symbol.for('options')].props, keys);
    }
    /**
     * Return values except the given keys
     */
    except(keys) {
        return utils_1.lodash.omit(this[Symbol.for('options')].props, keys);
    }
    /**
     * Serialize all props to a string of HTML attributes
     */
    serialize(mergeProps) {
        const attributes = utils_1.lodash.merge({}, this[Symbol.for('options')].props, mergeProps);
