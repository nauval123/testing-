...
declare module '@ioc:Adonis/Lucid/Model' {
    ...
    import { Update, Counter, OneOrMany, Aggregate, ChainableContract, SimplePaginatorMetaKeys, SimplePaginatorContract, ExcutableQueryBuilderContract } from '@ioc:Adonis/Lucid/DatabaseQueryBuilder';
    import { DialectContract, QueryClientContract, TransactionClientContract } from '@ioc:Adonis/Lucid/Database';
    import { Has, Preload, WhereHas, WithCount, WithAggregate, ModelRelations, RelationOptions, PreloaderContract, ModelRelationTypes, RelationshipsContract, ExtractModelRelations, ThroughRelationOptions, ManyToManyRelationOptions } from '@ioc:Adonis/Lucid/Relations';
    /**
     * ------------------------------------------------------
     *  Helpers
     * ------------------------------------------------------
