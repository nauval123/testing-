...
class Build extends standalone_1.BaseCommand {
    ...
    async run() {
        ...
        try {
            if (this.production) {
                await new Compiler(this.application.appRoot, this.encoreArgs, this.assets, this.logger, this.tsconfig).compileForProduction(stopOnError, this.client);
            }
            else {
                await new Compiler(this.application.appRoot, this.encoreArgs, this.assets, this.logger, this.tsconfig).compile(stopOnError);
            }
        }
        catch (error) {
...
__decorate([
    standalone_1.flags.string({
        ...
        default: paths_1.TSCONFIG_FILE_NAME,
    }),
