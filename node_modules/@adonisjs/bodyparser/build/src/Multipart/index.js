...
class Multipart {
    ...
    async handlePart(part) {
         ...
         */
        const partHandler = new PartHandler_1.PartHandler(part, handler.options);
        partHandler.begin();
        /**
    ...
    processConfig(config) {
         ...
         */
        this.upperLimit =
            typeof this.config.limit === 'string' ? bytes_1.default(this.config.limit) : this.config.limit;
    }
    /**
    ...
    process(config) {
        return new Promise((resolve, reject) => {
            ...
            this.form = new multiparty_1.default.Form({ maxFields: this.config.maxFields });
            /**
            ...
            this.form.on('error', (error) => {
                ...
                process.nextTick(() => {
                    ...
                    if (error.message === 'maxFields 1 exceeded.') {
                        reject(new utils_1.Exception('Max fields limit exceeded', 413, 'E_REQUEST_ENTITY_TOO_LARGE'));
                    }
                    else {
                        reject(error);
                    }
